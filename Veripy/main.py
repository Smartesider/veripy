...
# Hovedkommentar:
# - Dette oppsettet sikrer alle steg:
#   - Sikkerhet via API-nøkkel
#   - All feilhåndtering gir klare svar til klient
#   - Logger ALT som skjer med tid og ip
#   - Selve valideringslogikken ligger i validator.py, og kan utvides med flere kravfiler eller logikk uten å endre API
